...
rankTest('case 11 : voyage length is 16 zone is east-indies  and history without china history length is 3', t => {
  const voyage = {
    zone: 'east-indies',
    length: 16,
  };
...
rankTest('case 12 : voyage length is 16 zone is east-indies  and history without china history length is 10', t => {
  const voyage = {
    zone: 'east-indies',
    length: 16,
  };
...
rankTest('case 13 : voyage length is 16 zone is china  and history without china history length is 10', t => {
  const voyage = {
    zone: 'china',
    length: 16,
  };
...
rankTest('case 14 : voyage length is 16 zone is china  and history has china history length is 13', t => {
  const voyage = {
    zone: 'china',
    length: 16,
  };
...
rankTest('case 15 : voyage length is 3 zone is west-africa and history has china history length is 13', t => {
  const voyage = {
    zone: 'west-africa',
    length: 3,
  };
...
rankTest('case 17 : voyage length is 6 zone is west-africa and history has china history length is 13', t => {
  const voyage = {
    zone: 'west-africa',
    length: 9,
  };
...
rankTest('case 18 : voyage length is 6 zone is china and history has china history length is 13', t => {
  const voyage = {
    zone: 'china',
    length: 9,
  };
...
rankTest('case 19 : voyage length is 6 zone is east-indies and history has china history length is 13', t => {
  const voyage = {
    zone: 'east-indies',
    length: 9,
  };
...
rankTest('case 20 : voyage length is 6 zone is east-indies and history has china history length is 13', t => {
  const voyage = {
    zone: 'east-indies',
    length: 3,
  };
...
rankTest('case 21 : voyage length is 7 zone is east-indies and history has china history length is 13', t => {
  const voyage = {
    zone: 'east-indies',
    length: 7,
  };
